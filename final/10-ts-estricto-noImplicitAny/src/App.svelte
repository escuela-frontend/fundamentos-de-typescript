<script lang="ts">
   ...
   * Tenemos una instancia de nuestro tipo `ShoppingCart` y una
   * función de callback para añadir un item al `ShoppingCart`
   */
...
<main>
  ...
  <Menu {addCartItem} />
  <Cart
    items={cart.groupedItems()}
    amount={cart.numberOfItems()}
    total={cart.total()}
  />
</main>
