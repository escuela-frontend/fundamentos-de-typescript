...
/*
 * ❗️ Agrega la clase abstracta `Face` con función abstracta 
 * `value` que retorna un `number`.
 *
 * ❗️ Agrega las seis subclases que mencionamos antes, 
 * cada una con una implementación de `value()` 
 * que retorna un valor correspondiente al número.
 *
 * ❗️ Crédito extra: Agrega `SevenFace` y `EightFace`. 
 * ¿Qué nos falta para poder usarlos?
 */
