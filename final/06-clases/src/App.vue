<!-- 👇 Componente principal de nuestra aplicación Vue.
      Usa una serie de tipos `Dice` para tirar los dados y 
      mirar el puntaje -->
...
// 🛎 Con `ref`, Vue nos permite controlar un valor. 
//    En este caso, es un arreglo de 4 dados
...
<template>
  <div id="game">
    ...
    <h1>
      <!-- 🛎 Usar los dados para mostrar el puntaje -->
      {{dice.reduce((sum, die) => sum + die.value(), 0)}}
      <!-- 🛎 Usar el puntaje para mostrar si uno ganó o perdió -->
